...
import com.mygym.utils.MusicController;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File folder = new File(Environment.getExternalStorageDirectory() + "/Mygym");
        boolean success = true;
        if (!folder.exists()) {
            success = folder.mkdir();
        }
        if (success) {
            folder = new File(Environment.getExternalStorageDirectory() + "/Mygym/crashreport");
            success = folder.mkdir();
        }
        ...
        if (folder.exists()) {
            if (!(Thread.getDefaultUncaughtExceptionHandler() instanceof CustomExceptionHandler)) {
                Thread.setDefaultUncaughtExceptionHandler(new CustomExceptionHandler(
                    Environment.getExternalStorageDirectory() + "/Mygym/crashreport"));
            }
        }
