...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String OLD09_DATABASE_NAME = "mygym";
    public static final String DATABASE_NAME = "mygym.db";
        ...
        while (upgradeTo <= newVersion) {
            switch (upgradeTo) {
                ...
                case 5:
                    ...
                    break;
                case 6: // mygym 0.8
                    if (!isFieldExist(db, DAOMachine.TABLE_NAME, DAOMachine.BODYPARTS)) // mygym 0.9 : Probleme d'upgrade
