...
public class ProfileFragment extends Fragment {
    ...
    public static ProfileFragment newInstance(String name, int id) {
        ProfileFragment f = new ProfileFragment(); //new instance
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDb = new DAOProfil(view.getContext()); // db connection
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case ImageUtil.REQUEST_PICK_GALERY_PHOTO:
                ...
                //to crop image and image's permissions, all operations
            ...
            case CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    // Move the file to the Mygym directory
                    ...
                    if (!Environment.MEDIA_MOUNTED.equals(state)) {
                        ...
                        //We use the Mygym directory for saving our .csv file.
                        storageDir = Environment.getExternalStoragePublicDirectory("/Mygym/Camera/");
