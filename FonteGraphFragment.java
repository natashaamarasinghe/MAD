...
import com.mygym.GraphData;
import com.mygym.MainActivity;
import com.mygym.R;
import com.mygym.graph.BarGraph;
import com.mygym.graph.DateGraph;
import com.mygym.graph.DateGraph.zoomType;
...
public class FonteGraphFragment extends Fragment {
    ...
    private void drawGraph() {
        ...
        if (machineList.getSelectedItem() == null) {
            return;
        }// Avoids problems in case there is no recording machine
